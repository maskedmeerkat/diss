...
\begin{center}
	...
	\captionof{figure}{\label{fig:gt_exp_qual_results}Qualitative results of the different models trained in the experiments as numbered in Fig. \ref{tab:networking_tuning_exp_setup} with the radar input R$_{1}$ and the ground-truth \gls{gt}.}
\end{center}
\begin{center}
...
%		\hline
	...
	\end{tabular}
	\captionof{figure}{\label{tab:deep_ism_r20_results}Results of deep \gls{ism} variants trained on R$_1$ and R$_{20}$ images for visible, occluded and overall areas.  For a detailed explanation of the table format kindly refer to Section \ref{subsec:confusion_matrix}.}
\end{center}
\begin{center}
...
\begin{center}
	...
	\hline
	\multicolumn{2}{c|}{R$_{20|1}$ Scores}& \multicolumn{4}{c|}{overall} & \multicolumn{4}{c|}{visible} & \multicolumn{4}{c}{occluded}
\end{tabular}
\captionof{table}{\label{tab:deep_ism_r20_1_results}Normed confusion matrix evaluated on ShiftNet model which was trained on R$_{20|1}$ inputs. For a detailed explanation of the table format kindly refer to Section \ref{subsec:confusion_matrix}.}
\end{center}
...
\begin{center}
	...
	\captionof{figure}{\label{fig:qual_comp_radar_encoding}Qualitative comparison of ShiftNet predictions (middle) trained on radar inputs with three different dynamic detection encodings (bottom) shown for two scenes with the respective lidar occupancy map patch as ground-truth (top).}
\end{center}
...
\end{tabular}
\captionof{table}{\label{tab:deep_icm_results}Normed confusion matrix evaluated on the ShiftNet model which was trained on \gls{c_rgb}, \gls{c_s}, \gls{c_d} and, finally, the fusion of \gls{c_d} and R$_{20}$. For a detailed explanation of the table format kindly refer to Section \ref{subsec:confusion_matrix}.}
\end{center}
