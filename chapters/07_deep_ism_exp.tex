...
\\
The metric used to quantify the results is a confusion matrix where the count of predictions in each row is averaged by the amount of true pixels for the row. This makes it possible to handle the huge amount of class predictions by using a running average to as an update scheme. The confusion matrix variant is preferred over the mIoU score since it provides a more detailed means of analysis. 
%======================================%
%
%======================================%
\subsection{Experimental Results}
