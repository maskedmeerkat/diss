...
\begin{align}
	\vec{m} = \begin{bmatrix} m(\gls{sym:set_f}), & m(\gls{sym:set_o}), & m(\gls{sym:set_u}) \end{bmatrix}^{\text{T}} = \begin{bmatrix} m_f, & m_o, & m_u \end{bmatrix}^{\text{T}}
\end{align}
...
\begin{align}
	\label{eq:gauss_idm}
	\text{\gls{idm}}_{\text{Gauss}}(r,\tilde{\mu}_r, \sigma_r, \varphi = \mu_\varphi) = P(\gls{sym:p_o}(r, \varphi = \mu_\varphi) = 1 |\tilde{\mu}_r)  =& \dfrac{1}{2}\text{Erf}\left(\dfrac{\tilde{\mu}_r-r}{\sqrt{2}\sigma_r}\right)\\
