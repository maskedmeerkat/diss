...
\begin{figure}[H]
	\begin{center}
		...
		\caption{\label{fig:comparison_of_maps_diff_sens}Qualitative results of the occupancy maps created using different ISMs. The abbreviations are explained in Section \ref{subsec:setup_analyze_deep_ism_maps_diff_sensors}.}
	\end{center}
\end{figure}
