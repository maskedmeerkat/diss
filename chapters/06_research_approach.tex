...
In this section, the \gls{sota} defined in Ch. \ref{ch:state_of_the_art} is analyzed with respect to the requirements defined in Section \ref{sec:requirements}.
%======================================%
%
%======================================%
